        ...
        <div class="p-6 border-b border-gray-100 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <form method="GET" class="flex flex-col md:flex-row gap-3 md:items-center">
                <div class="flex items-center gap-2">
                    ...
                    <select id="status" name="status" class="rounded-lg border-gray-300 focus:ring-unand-500 focus:border-unand-500 text-sm">
                ...
                <button type="submit" class="inline-flex items-center justify-center px-4 py-2 bg-unand-600 text-white text-sm font-semibold rounded-lg hover:bg-unand-700 transition">
                    Terapkan
                </button>
            </form>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @endphp
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold {{ $badgeColors[$status] ?? 'bg-gray-100 text-gray-800' }}">
