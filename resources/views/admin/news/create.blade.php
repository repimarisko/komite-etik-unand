    ...
    <div class="p-6 text-gray-900">
        ...
        <div class="flex items-center mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1">Buat berita atau pengumuman baru untuk dashboard</p>
            </div>
        </div>
        ...
        <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <!-- Banner Image -->
            <div>
                <label for="banner_image" class="block text-sm font-medium text-gray-700 mb-2">Banner Gambar (Opsional)</label>
