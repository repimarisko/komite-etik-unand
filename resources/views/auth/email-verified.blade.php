        ...
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    Sistem tidak lagi memerlukan verifikasi email. Data Anda otomatis diterima dan sedang menunggu verifikasi operator serta super admin.
                </p>
            </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-md p-4">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="ml-2 text-sm text-blue-700">✓ Email diterima</span>
                        </div>
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                            ...
                            <span class="ml-2 text-sm text-blue-700">⏳ Menunggu verifikasi operator & super admin</span>
                        </div>
                    </div>
                </div>
            </div>
